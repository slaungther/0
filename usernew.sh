...
echo -e "Port SSH WS NONTLS  : 2095"
echo -e "Port SSH WS TLS     : 2096"
...
echo -e "${domain}[crlf]Connection:"
echo -e "Keep-Alive[crlf]User-Agent: [ua][crlf]Upgrade:"
echo -e "websocket[crlf][crlf]"
echo -e "==============================="
